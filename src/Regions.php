 ...
 *
 * Charitable donations store a donor country and state. UK checkout writes
...
class Regions {
	...
	/**
	 * UK counties as Charitable stores them in the donor state field.
	 *
	 * Keys are county names, not ENG/SCT/WLS/NIR codes, because Charitable
